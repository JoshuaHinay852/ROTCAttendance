...
// Get Cadet ID from URL
$cadet_id = isset($_GET['id']) ? intval($_GET['id']) : 0;
...
// Fetch Cadet data
$stmt = $pdo->prepare("SELECT * FROM cadet_accounts WHERE id = ? AND is_archived = FALSE");
$stmt->execute([$cadet_id]);
$cadet = $stmt->fetch();

if (!$cadet) {
    $_SESSION['error'] = "Cadet account not found or has been archived.";
    header('Location: cadets.php');
    exit();
}
...
$status_class = $status_classes[$cadet['status']] ?? 'bg-gray-100 text-gray-800';
?>
...
<head>
    ...
    <title><?php echo htmlspecialchars($cadet['first_name'] . ' ' . $cadet['last_name']); ?> | Cadet Profile</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="main-content ml-64 min-h-screen">
        ...
        <div class="bg-white border-b border-gray-200 px-8 py-4">
            <a href="cadets.php" class="inline-flex items-center text-gray-600 hover:text-gray-900">
        ...
        <main class="p-8">
            <!-- Profile Header -->
            <div class="cadet-header rounded-xl shadow-lg overflow-hidden mb-8">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold">
                                    ...
                                    <?php if ($cadet['middle_name']): ?>
                                        <span class="text-white/80"><?php echo htmlspecialchars($cadet['middle_name'][0] . '.'); ?></span>
                                    <?php endif; ?>
                                </h1>
                                <p class="text-white/90 mt-2">
                                    <span class="badge platoon-badge">Platoon <?php echo htmlspecialchars($cadet['platoon']); ?></span>
                                    <span class="badge company-badge ml-2"><?php echo htmlspecialchars($cadet['company']); ?> Company</span>
                                    <span class="badge <?php echo $status_class; ?> ml-2">
                                        <?php echo ucfirst($cadet['status']); ?>
                                    </span>
                                </p>
                                <p class="text-white/80 mt-2">
                                    <i class="fas fa-graduation-cap mr-2"></i><?php echo htmlspecialchars($cadet['course']); ?>
                                    <i class="fas fa-id-badge ml-4 mr-2"></i>Cadet ID: <?php echo $cadet['id']; ?>
                                </p>
                            </div>
                        </div>
                        <div class="mt-4 md:mt-0">
                            <div class="flex space-x-3">
                                <a href="cadets.php?action=edit&id=<?php echo $cadet['id']; ?>" 
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden info-card">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-4">
                                    ...
                                    <p class="text-gray-900 font-medium">
                                        <?php echo htmlspecialchars($cadet['first_name'] . ' ' . $cadet['last_name']); ?>
                                        <?php if ($cadet['middle_name']): ?>
                                            <span class="text-gray-600">(<?php echo htmlspecialchars($cadet['middle_name']); ?>)</span>
                                        <?php endif; ?>
                                    </p>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <p class="text-gray-900 font-medium">
                                            <?php echo date('F j, Y', strtotime($cadet['dob'])); ?>
                                        </p>
                                        <?php if ($age): ?>
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    <p class="text-gray-900 font-medium"><?php echo htmlspecialchars($cadet['course']); ?></p>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <p class="text-gray-900 font-medium"><?php echo htmlspecialchars($cadet['mothers_name']); ?></p>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <p class="text-gray-900 font-medium"><?php echo htmlspecialchars($cadet['fathers_name']); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-200">
                            ...
                            <p class="text-gray-900"><?php echo htmlspecialchars($cadet['full_address']); ?></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="flex items-center mt-2">
                                    <div class="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mr-4">
                                        <span class="text-blue-600 font-bold text-lg"><?php echo htmlspecialchars($cadet['platoon']); ?></span>
                                    </div>
                                    <div>
                                        <p class="text-gray-900 font-medium text-lg">Platoon <?php echo htmlspecialchars($cadet['platoon']); ?></p>
                                ...
                                <div class="flex items-center mt-2">
                                    <div class="w-12 h-12 rounded-full bg-pink-100 flex items-center justify-center mr-4">
                                        <span class="text-pink-600 font-bold text-lg">
                                            <?php echo strtoupper(substr($cadet['company'], 0, 1)); ?>
                                        </span>
                                    </div>
                                    <div>
                                        <p class="text-gray-900 font-medium text-lg"><?php echo htmlspecialchars($cadet['company']); ?> Company</p>
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                ...
                                <div class="flex items-center mt-2">
                                    ...
                                    <div>
                                        <p class="text-gray-900 font-medium">
                                            <?php echo date('F j, Y', strtotime($cadet['created_at'])); ?>
                                        </p>
                                        <p class="text-sm text-gray-500">
                                            <?php echo date('g:i A', strtotime($cadet['created_at'])); ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-6">
                                    ...
                                    <p class="text-gray-900 font-medium text-lg">@<?php echo htmlspecialchars($cadet['username']); ?></p>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <p class="text-gray-900 font-medium text-lg"><?php echo htmlspecialchars($cadet['email']); ?></p>
                                </div>
                            </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <p class="text-gray-900 font-medium">
                                        <?php if ($cadet['last_login']): ?>
                                            <?php echo date('F j, Y', strtotime($cadet['last_login'])); ?>
                                            <span class="block text-sm text-gray-500">
                                                <?php echo date('g:i A', strtotime($cadet['last_login'])); ?>
                                            </span>
                                        <?php else: ?>
                        ...
                        <div class="space-y-6">
                                    ...
                                    <div>
                                        <p class="text-gray-900 font-medium">
                                            <?php if ($cadet['updated_at']): ?>
                                                <?php echo date('F j, Y', strtotime($cadet['updated_at'])); ?>
                                            <?php else: ?>
                                        ...
                                        <?php if ($cadet['updated_at']): ?>
                                            <p class="text-sm text-gray-500">
                                                <?php echo date('g:i A', strtotime($cadet['updated_at'])); ?>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                ...
                                <div class="flex items-center mt-2">
                                    ...
                                    <p class="text-gray-900 font-medium text-lg font-mono"><?php echo $cadet['id']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden info-card">
                ...
                <div class="p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <div class="mb-6">
                                <h3 class="font-medium text-gray-900">Cadet Account Created</h3>
                                <p class="text-sm text-gray-600"><?php echo date('F j, Y g:i A', strtotime($cadet['created_at'])); ?></p>
                                <p class="text-sm text-gray-500 mt-1">Cadet account was created by <?php echo htmlspecialchars($created_by_name); ?></p>
                            </div>
                            ...
                            <?php if ($cadet['last_login']): ?>
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-600"><?php echo date('F j, Y g:i A', strtotime($cadet['last_login'])); ?></p>
                                        <p class="text-sm text-gray-500 mt-1">Last successful login to the system</p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            
                            <?php if ($cadet['updated_at'] && $cadet['updated_at'] != $cadet['created_at']): ?>
                                <div class="flex items-start space-x-4 mt-6">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-600"><?php echo date('F j, Y g:i A', strtotime($cadet['updated_at'])); ?></p>
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <div class="mt-4">
                    ...
                    <form id="resetPasswordForm" method="POST" action="cadets.php">
    ...
    <script>
        ...
        function showResetPasswordModal(id, username, type = 'cadet') {
